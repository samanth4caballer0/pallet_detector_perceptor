...
{
	std::cout << "Test Detector Reflector" << std::endl;

	TargetDetector::DetectorReflector detector__;
	std::map<std::string, double> detector_params__;

	// configure
	detector_params__["min_reflector_intensity"] = 500;
	detector_params__["reflector_width"] = 0.04;
	detector_params__["max_reflector_range"] = 20;
